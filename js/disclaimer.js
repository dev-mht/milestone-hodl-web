/**
 * disclaimer.js
 * Blocking legal disclaimer popup for Milestone HODL Token / ApexPad.
...
(function () {
  ...
  var STORAGE_KEY = "mht_legal_consent_v1"; // bump the _v1 if you ever change the terms, to force re-acceptance
  var LEGAL_PAGE_URL = "pages/legal.html"; // adjust path depending on which page includes this script

  var CHECK_ITEMS = [
    "I understand this is not financial, legal, or tax advice.",
    "I understand MHT is a decentralized token with no issuing entity, no guarantee of profit, and that I may lose some or all of my funds.",
  ...
  function buildModal() {
    ...
    intro.textContent =
      "Please read and confirm the following before accessing this site. MHT is a decentralized utility token with no issuing entity — you must understand and accept the risks.";
